...
Asset* AllocAsset(int asset_id, BlockRotation rot, double game_time)
{
	...
	switch(asset_id)
	{
		...
		case(B1x1AR0):
			...
			//asset->tris[8] = (Tri){1*BU, 0*BU, 1*BU, 8*BU, 7*BU, 8*BU, RM_WHITE5};
			//asset->tris[9] = (Tri){1*BU, 0*BU, 7*BU, 8*BU, 7*BU, 0*BU, RM_WHITE5};
			break;
		case(B1x1AT0):
			asset = MallocAsset(15);
			asset->tris[0] = (Tri){0*BU, 0*BU, 0*BU, 8*BU, 8*BU, 8*BU, RM_WHITE5};
			asset->tris[1] = (Tri){0*BU, 0*BU, 8*BU, 8*BU, 8*BU, 0*BU, RM_WHITE5};
			asset->tris[2] = (Tri){0.000000*BU, 7.500000*BU, 0.500000*BU, 8.000000*BU, 1.000000*BU, 8.000000*BU, RM_WHITE7};
			asset->tris[3] = (Tri){1.000000*BU, 8.000000*BU, 0.000000*BU, 7.000000*BU, 0.000000*BU, 7.500000*BU, RM_WHITE7};
			asset->tris[4] = (Tri){7.000000*BU, 8.000000*BU, 7.500000*BU, 8.000000*BU, 6.5*BU, 4.5*BU, RM_WHITE7};
			asset->tris[5] = (Tri){0.000000*BU, 0.500000*BU, 0.000000*BU, 1.000000*BU, 3.500000*BU, 1.500000*BU, RM_WHITE7};
			asset->tris[6] = (Tri){3.500000*BU, 1.500000*BU, 6.5*BU, 4.5*BU, 5.375000*BU, 2.625000*BU, RM_WHITE7};
			asset->tris[7] = (Tri){0.000000*BU, 0.500000*BU, 3.500000*BU, 1.500000*BU, 3.750000*BU, 1.000000*BU, RM_WHITE7};
			asset->tris[8] = (Tri){5.375000*BU, 2.625000*BU, 3.750000*BU, 1.000000*BU, 3.500000*BU, 1.500000*BU, RM_WHITE7};
			asset->tris[9] = (Tri){7.500000*BU, 8.000000*BU, 7*BU, 4.25*BU, 6.5*BU, 4.5*BU, RM_WHITE7};
			asset->tris[10] = (Tri){7*BU, 4.25*BU, 5.375000*BU, 2.625000*BU, 6.5*BU, 4.5*BU, RM_WHITE7};
