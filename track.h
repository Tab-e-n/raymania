...
#define PIECE_CATALOGUE_START_PAGE PAGE_ROAD_BASE
//#define UNDO_LIST_LENGHT 10*BLOCKS_PER_PIECE

#define MAX_CHECKPOINTS 9
#define MEDAL_BRONZ_MULT 1.5
#define MEDAL_SILVER_MULT 1.2
#define MEDAL_GOLD_MULT 1.1
